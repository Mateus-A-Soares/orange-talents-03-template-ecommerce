...
/**
 * 
 * Classe modelo para geração da tabela que interliga o path das imagens a um produto.
 * 
...
public class ImagemUrl {
	 ...
	 * @param url		url de acesso a imagem, deve estar formatado como url, ser único e é obrigatório;
	 */
